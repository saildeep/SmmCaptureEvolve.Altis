...
class ace_medical_litterSimulationDetail {
	// default value 3, ammout of medical trash in local area, high fps, client only, 0-4
    value = 1;
    typeName = "SCALAR";
    force = 1;
};
...
class ace_medical_useLocation_SurgicalKit {
	//default 0, 0= anywhere ,1 =vehicles, 2=facility, 3= vehicles+facility, 4=disable
    value = 3;
    typeName = "SCALAR";
    force = 1;
};
