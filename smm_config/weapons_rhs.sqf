startWeapons   = ["rhsusf_weap_MP7A2","rhs_weap_M136"];
startMagazines = [];
...
rand_items_two append ("(_x call macros_isgood) and (_x call macros_isitem) and (_x call smm_is_not_thermal) && (count (configName _x) > 3) && (toLower ((configName _x) select [0,3])) == 'rhs' && (isNumber (_x >> 'ItemInfo' >> 'type' )) && (getNumber (_x >> 'ItemInfo' >> 'type') in [101, 201, 301, 302])" configClasses (configFile >> "CfgWeapons") apply {configName _x});
rand_items_one append (("(_x call macros_isgood) and (_x call macros_isitem) and (_x call smm_is_not_thermal) && (count (configName _x) > 3) && (toLower ((configName _x) select [0,3])) == 'rhs' && !(isText (_x >> 'ItemInfo' >> 'uniformClass'))" configClasses (configFile >> "CfgWeapons") apply {configName _x}) - rand_items_two);
rand_backpacks = "(_x call macros_isgood) and (_x call macros_isbackpack) && (count (configName _x) > 3) && (toLower ((configName _x) select [0,3])) == 'rhs'" configClasses (configFile >> "CfgVehicles") apply {configName _x};
