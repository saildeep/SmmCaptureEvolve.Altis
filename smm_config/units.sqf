...
if(playerSide == west)then{
	buy_units = [
		...
		["B_Heli_Transport_03_F",35000,{},"LOGISTIC__BLUFOR",""] call PurchasableVehicle_create,
		...
		["B_Heli_Transport_01_F",35000,{},"LOGISTIC__BLUFOR",""] call PurchasableVehicle_create,
